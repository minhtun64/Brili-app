...
export default function CurriculumVitae({ navigation }) {
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.container} enabled keyboardVerticalOffset={Platform.select({ ios: 20, android: 100 })}>
            ...
            <ScrollView onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
                <DismissKeyboardView>
                    <View style={styles.formInput}>
                        ...
                        <TextInput style={styles.Content} placeholder="Họ và tên"></TextInput>
                    </View>
                    <View style={styles.formInput}>
                    ...
                    <Modal isVisible={isModalVisible}>
                        <View style={styles.popup}>
                            <View>
                                <Text style={styles.TextConfirm2}>Xác nhận gửi hồ sơ ứng tuyển?</Text>
                            </View>
