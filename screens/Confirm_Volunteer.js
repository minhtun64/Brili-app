  ...
  return (
    ...
    >
      ...
      <ScrollView onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
        <DismissKeyboardView style={{ marginTop: 32 }}>
            ...
            <View>
              <TouchableOpacity style={styles.buttonDate}>
                ...
                <Image
                  ...
                  source={require("../assets/icons/arrow-square-down.png")}
                ></Image>
              </TouchableOpacity>
            </View>
            <View>
            ...
            <View style={styles.popup}>
              <View>
                <Text style={styles.TextConfirm2}>
                  Bạn chắc chắn với thông tin doanh nghiệp?
                </Text>
              </View>
              <View style={styles.btnConfirm}>
                ...
                <TouchableOpacity
                  style={styles.send}
                  onPress={() => navigation.navigate("RecruitmentScreenV")}
                >
